...
import capslearn.torch.utils.others as others
from capslearn.torch.utils.others import AverageMeter
from capslearn.torch.utils.others import ProgressMeter
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    with torch.profiler.profile(
            ...
            on_trace_ready=torch.profiler.tensorboard_trace_handler('/home/with1015/capslearn/capslearn/logs/resnet50'),
            record_shapes=True,
            with_stack=True
    ) as prof:
